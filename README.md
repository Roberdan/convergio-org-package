...
[![CI](https://github.com/Roberdan/convergio-org-package/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-org-package/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-org-package/blob/main/LICENSE)
...
```mermaid
graph LR
    CRATE[convergio-org-package] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-org-package = { git = "https://github.com/Roberdan/convergio-org-package", tag = "v0.1.0" }
```
